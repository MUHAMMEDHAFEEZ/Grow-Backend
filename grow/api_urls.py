...
assignments_router = nested_routers.NestedSimpleRouter(root_router, r"courses", lookup="course")
assignments_router.register(r"assignments", AssignmentViewSet, basename="course-assignment")

submissions_router = nested_routers.NestedSimpleRouter(
    assignments_router, r"assignments", lookup="assignment"
)
submissions_router.register(r"submissions", SubmissionViewSet, basename="assignment-submission")
