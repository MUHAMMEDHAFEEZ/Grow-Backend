...
CREATE TABLE IF NOT EXISTS "accounts_school" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "accounts_parentprofile" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "accounts_enrollmentcode" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "token" char(32) NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS "accounts_enrollmentcodeevent" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "accounts_enrollmentratelimit" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "accounts_schoolmembership" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE INDEX "schools_grade_school_id_6e75f5fe" ON "schools_grade" ("school_id");

CREATE TABLE IF NOT EXISTS "schools_registrationcode" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE INDEX "schools_reg_school__d94909_idx" ON "schools_registrationcode" ("school_id", "code_type", "is_used");
CREATE INDEX "schools_reg_code_fdf3e8_idx" ON "schools_registrationcode" ("code");
CREATE INDEX "schools_registrationcode_grade_id_35330697" ON "schools_registrationcode" ("grade_id");
CREATE INDEX "schools_registrationcode_school_id_cc829c7d" ON "schools_registrationcode" ("school_id");
CREATE INDEX "schools_registrationcode_used_by_id_72eaf0ac" ON "schools_registrationcode" ("used_by_id");
...
CREATE TABLE IF NOT EXISTS "schools_course" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE UNIQUE INDEX "schools_course_subject_id_grade_id_school_type_section_2ee599f5_uniq" ON "schools_course" ("subject_id", "grade_id", "school_type", "section");
...
CREATE TABLE IF NOT EXISTS "courses_studentcourse" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "is_active" bool NOT NULL,
...
CREATE TABLE IF NOT EXISTS "courses_courseprogress" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "courses_lessonactivity" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "courses_quiz" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "title" varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "courses_quizattempt" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "courses_question" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "text" text NOT NULL,
    "order" integer unsigned NOT NULL CHECK ("order" >= 0),
    "quiz_id" bigint NOT NULL REFERENCES "courses_quiz" ("id") DEFERRABLE INITIALLY DEFERRED
...
CREATE TABLE IF NOT EXISTS "courses_answeroption" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "courses_quizsubmission" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "dashboard_dashboardinsight" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "title" varchar(255) NOT NULL,
    "description" text NOT NULL,
...
CREATE TABLE IF NOT EXISTS "dashboard_studentnote" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "note" text NOT NULL,
    "created_at" datetime NOT NULL,
    "updated_at" datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS "dashboard_interventionrecord" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "tasks_studenttask" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "students_otprecord" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "email" varchar(254) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "students_dailymasterlog" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "date" date NOT NULL,
...
CREATE TABLE IF NOT EXISTS "students_lessoncompletion" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "students_loginhistory" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "students_refreshtoken" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "students_studentcourseprogress" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "students_studentnotification" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "students_studentsession" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "students_studentaddratelimit" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "failed_attempts" integer NOT NULL,
    "window_start" datetime NULL,
    "locked_until" datetime NULL,
...
CREATE TABLE IF NOT EXISTS "study_sessions_studysession" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "started_at" datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS "study_sessions_loginhistory" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "login_date" date NOT NULL,
    "student_id" bigint NOT NULL REFERENCES "accounts_user" ("id") DEFERRABLE INITIALLY DEFERRED
);
...
CREATE TABLE IF NOT EXISTS "xp_xptransaction" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "teachers_teacherprofile" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "bio" text NOT NULL,
    "avatar" varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "teachers_teachercode" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "teachers_otprecord" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "email" varchar(254) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "teachers_refreshtoken" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "teachers_devicesession" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "teachers_auditlog" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "teachers_teachernotification" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "event_type" varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "teachers_teachernotificationpreference" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
